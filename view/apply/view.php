    ...
    <form class="layui-form">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="sale_id" required lay-verify="required" value="{$sale_list[$detail['sale_id']]}" class="layui-input layui-disabled" disabled autocomplete="off">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <select name="pay_type" lay-verify="required" disabled autocomplete="off">
                    <option value="{$detail.pay_type}">{$detail.pay_type}</option>
                </select>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="pay_amount" required lay-verify="required" value="{$detail.pay_amount}" class="layui-input layui-disabled" disabled autocomplete="off">
            </div>
        </div>
        <div class="layui-form-item">
		...
		<div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="bao_time" lay-verify="required" placeholder="请输入缴费时间" class="layui-input" id="LAY_demorange_s" value="{$detail.bao_time}" onclick="layui.laydate({elem: this, istime: true, format: 'YYYY-MM-DD hh:mm:ss'})" disabled autocomplete="off">
                        </div>
                    </div>
        <div class="layui-form-item">
            <label class="layui-form-label">其它备注：</label>
            <div class="layui-input-block">
                <input type="text" name="memo" required lay-verify="required" value="{$detail.memo}" class="layui-input layui-disabled" disabled autocomplete="off">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="address" required lay-verify="required" value="{$detail.address}" class="layui-input layui-disabled" disabled autocomplete="off" >
            </div>
        </div>
    </form>
</div>
