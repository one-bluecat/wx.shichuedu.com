            ...
            <div class="layui-tab-item layui-show">
                <form class="layui-form" id="admin">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="student_phone" lay-verify="phone" placeholder="请输入收货人手机号" class="layui-input" id="student_phone" value="{$detail.student_phone}">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label"><span style="color: red;">*</span>邮寄商品：</label>
                        <div class="layui-input-block">
                            <input type="text" name="goods" lay-verify="required" placeholder="请输入邮寄内容" class="layui-input" id="goods" value="{$detail.goods}">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label"><span style="color: red;">*</span>邮寄原因：</label>
                        <div class="layui-input-block">
                            <input type="text" name="reason" lay-verify="required" placeholder="请输入邮寄原因" class="layui-input" id="reason" value="{$detail.reason}">
                        </div>
                    </div>
                    <div class="layui-form-item">
