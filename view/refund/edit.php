			...
			<div class="layui-tab-item layui-show">
				<form class="layui-form" id="admin">
					...
					<div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="student_phone" lay-verify="phone" placeholder="请输入学员网校账号" class="layui-input" id="student_phone" value="{$detail.student_phone}">
                        </div>
					</div>
                    <div class="layui-form-item">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="pay_amount" lay-verify="required" placeholder="请输入退费金额" class="layui-input" id="pay_amount" value="{$detail.pay_amount}">
						</div>
					</div>
					<div class="layui-form-item layui-form-text">
						<label class="layui-form-label"><span style="color: red;">*</span>退费原因：</label>
						<div class="layui-input-block">
							<textarea name="reason" class="layui-textarea" id="reason" lay-verify="required">{$detail.reason}</textarea>
						</div>
					</div>
