            ...
            <form class="layui-form column-content-detail lay-ajax" method="post" id="admin">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="id" disabled autocomplete="off" class="layui-input layui-disabled" value="{$detail.limit}">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">负责人：</label>
                    <div class="layui-input-block">
                        <input type="text" name="name" required  lay-verify="required" placeholder="请输入标题" disabled autocomplete="off" class="layui-input layui-disabled" value="{$detail.charge}">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <select name="category" lay-verify="required" disabled autocomplete="off">
                            ...
                            foreach($school_list as $k=>$value){
                                ?><option value="{$k}" <?php if(isset($detail['id']) && $detail['id'] == $k){echo 'selected';}?>>{$value}</option>
                            <?php }
                            ?>
                        </select>
                    </div>
                ...
                <div class="layui-form-item layui-form-text">
                    ...
                    <div class="layui-input-block">
                        <textarea name="desc" class="layui-textarea">{$detail.mark}</textarea>
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-input-block">
...
<script>
    function updatePassword(){
        $.ajax({
            url:"{:url('index/admin/updatePassword')}",
