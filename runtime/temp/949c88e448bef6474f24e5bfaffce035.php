<?php /*a:1:{s:42:"D:\web\wx.shichuedu.com\view\ask\index.php";i:1605631763;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    ...
    <div class="layui-form" id="table-list">
        <table class="layui-table" lay-even lay-skin="nob">
            ...
            <tr>
                ...
                <td><?php echo htmlentities($vo['item2']); ?></td>
                ...
                <td>
                    <div class="layui-inline">
                        <div class="layui-inline">
                            ...
                            <button class="layui-btn layui-btn-small layui-btn-warm sendBtn" data-url="/index.php/ask/sendSms?id=<?php echo htmlentities($vo['id']); ?>" data-id="<?php echo htmlentities($vo['id']); ?>"><i class="layui-icon">&#xe609;</i></button>
                        </div>
                    </div>
                </td>
            </tr>
