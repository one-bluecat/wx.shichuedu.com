<?php /*a:1:{s:42:"D:\phpstudy_pro\WWW\tp6\view\apply\add.php";i:1606443908;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
				...
				<div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
						<input class="layui-input" name="bao_time" placeholder="请输入报名时间" id="LAY_demorange_s" onclick="layui.laydate({elem: this, istime: true, format: 'YYYY-MM-DD hh:mm:ss'})" value="<?php if(isset($_POST['bao_time'])) echo $_POST['bao_time'];?>">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">其它备注：</label>
                    <div class="layui-input-block">
                        <input type="text" name="memo" placeholder="请输入邮寄备注或额外赠送资料" class="layui-input" id="memo">
                    </div>
                </div>
            </div>
            <div class="layui-tab-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="address" lay-verify="required" placeholder="请输入具体地址" class="layui-input" id="address">
                    </div>
                </div>
                <div class="layui-form-item">
					<label class="layui-form-label"></label>
					<div class="layui-input-block">
						<label  style="color: red;">注：以上内容请仔细填写，提交后无法修改，如需更改请联系网络部同事，转账需要开课请提交后点击“小喇叭”按钮，直接购买无需开课提交即可。</label>
					</div>
				</div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function addApply(){
        $.ajax({
            url:"<?php echo url('index/apply/check'); ?>",
            ...
            success: function (res) {
                if(res.status){
                    layer.confirm(res.msg, {
                        ...
                        $.ajax({
                            url:"<?php echo url('index/apply/add'); ?>",
                            data:$('#admin').serialize(),
                            type:'post',
                            dataType:'json',
                            async: false,
