<?php /*a:1:{s:43:"D:\phpstudy_pro\WWW\tp6\view\apply\edit.php";i:1606120286;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            <div class="layui-tab-item layui-show">
                <form class="layui-form">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="student_name" lay-verify="required" placeholder="请输入报名学生姓名" autocomplete="off" class="layui-input" id="student_name" value="<?php echo htmlentities($detail['student_name']); ?>">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label"><span style="color: red;">*</span>学生手机：</label>
                        <div class="layui-input-block">
                            <input type="text" name="student_phone" lay-verify="required" placeholder="请输入学生手机号同网校账号" autocomplete="off" class="layui-input" id="student_phone" value="<?php echo htmlentities($detail['student_phone']); ?>">
                        </div>
                    </div>
					<div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <select name="pay_type" lay-verify="required">
                                ...
                                <option value="POS" <?php if($detail['pay_type'] == '刷卡') echo 'selected';?>>POS</option>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="pay_amount" lay-verify="required" placeholder="请输入学生本次实收金额" class="layui-input" id="Paymentamount" value="<?php echo htmlentities($detail['pay_amount']); ?>">
                        </div>
                    </div>
					...
					<div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="bao_time" lay-verify="required" placeholder="请输入报名时间" class="layui-input" id="LAY_demorange_s" value="<?php echo htmlentities($detail['bao_time']); ?>" onclick="layui.laydate({elem: this, istime: true, format: 'YYYY-MM-DD hh:mm:ss'})">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">其它备注：</label>
                        <div class="layui-input-block">
                            <input type="text" name="memo" placeholder="请输入邮寄备注或额外赠送资料" autocomplete="off" class="layui-input" value="<?php echo htmlentities($detail['memo']); ?>">
                        </div>
                    </div>
                    <div class="layui-form-item">
...
<script>
    ...
    function update(){
        $.ajax({
            url:"<?php echo url('index/apply/edit'); ?>",
