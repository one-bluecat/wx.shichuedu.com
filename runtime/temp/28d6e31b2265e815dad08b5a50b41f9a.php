<?php /*a:1:{s:43:"D:\web\wx.shichuedu.com\view\open\index.php";i:1605926075;}*/ ?>
<!DOCTYPE html>
<html class="iframe-h">
<head>
    <meta charset="UTF-8">
        ...
        <form class="layui-form" action="/index.php/open/index" method="post" id="form">
            <div class="layui-form-item">
                <div class="layui-inline tool-btn">
                    <button class="layui-btn layui-btn-small layui-btn-normal addBtn" data-url="/index.php/open/add"><i class="layui-icon">&#xe654;</i></button>
                    ...
                    <td>
                        <div class="layui-inline">
                            ...
                            if(isset($_SESSION['admin']['limit']) && $_SESSION['admin']['limit']==1){
                                ?>
                                <button class="layui-btn layui-btn-small layui-btn-normal go-btn goBtn"  data-url="/index.php/open/edit?id=<?php echo htmlentities($vo['id']); ?>"><i class="layui-icon">&#xe642;</i></button>
                            <?php }
                            ?>
                            <button style="margin-left:0px;" class="layui-btn layui-btn-small layui-btn-shua go-btn layui-btn-search  searchBtn" data-id="1" data-url="/index.php/open/view?id=<?php echo htmlentities($vo['id']); ?>"><i class="layui-icon">&#xe615;</i></button>
                            <?php
                            if(isset($_SESSION['admin']['limit']) && $_SESSION['admin']['limit']==1){
                             ?>
                            <button class="layui-btn layui-btn-small layui-btn-danger delBtn leftBtn"  data-url="/index.php/open/delete?id=<?php echo htmlentities($vo['id']); ?>"><i class="layui-icon">&#xe640;</i></button>
                            <?php }
                            ?>
                        </div>
                    </td>
...
<script>
    layui.use(['form', 'jquery', 'layer', 'dialog'], function() {
        ...
        $('#table-list').on('click', '.table-list-status', function() {
            ...
            $.ajax({
                url:"<?php echo url('index/open/stat'); ?>",
