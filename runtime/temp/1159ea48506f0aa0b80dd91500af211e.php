<?php /*a:1:{s:45:"D:\web\wx.shichuedu.com\view\refund\index.php";i:1605798703;}*/ ?>
<!DOCTYPE html>
<html class="iframe-h">
<head>
    <meta charset="UTF-8">
        ...
        <form class="layui-form" action="/index.php/refund/index" method="post" id="form">
            <div class="layui-form-item">
                <div class="layui-inline tool-btn">
                    <button class="layui-btn layui-btn-small layui-btn-normal addBtn" data-url="/index.php/refund/add"><i class="layui-icon">&#xe654;</i></button>
        ...
        <div class="layui-form" id="table-list" style="overflow-y:auto;">
            <table class="layui-table" lay-even lay-skin="nob">
                ...
                <tr>
                    ...
                    ?>
                    <td class="hidden-xs"><?php echo $course_str; ?></td>
                    ...
                    <td>
                        <div class="layui-inline">
                            ...
                            <?php }
                            ?>
                            <button style="margin-left:0px;" class="layui-btn layui-btn-small layui-btn-shua go-btn layui-btn-search  searchBtn" data-id="1" data-url="/index.php/refund/view?id=<?php echo htmlentities($vo['id']); ?>"><i class="layui-icon">&#xe615;</i></button>
                            <?php
                            if(isset($_SESSION['admin']['limit']) && $_SESSION['admin']['limit']==1){
                                ?>
