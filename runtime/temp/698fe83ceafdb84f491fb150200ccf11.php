<?php /*a:1:{s:50:"/www/wwwroot/wx.shichuedu.com/view/index/index.php";i:1662434890;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="main-layout" id='main-layout'>
    ...
    <div class="main-layout-side">
        ...
        <ul class="layui-nav layui-nav-tree" lay-filter="leftNav">
            ...
            <?php
            if(isset($_SESSION['admin']['limit']) && $_SESSION['admin']['limit']!=3&& $_SESSION['admin']['limit']!=1){
                ?>
                <li class="layui-nav-item layui-nav-itemed">
