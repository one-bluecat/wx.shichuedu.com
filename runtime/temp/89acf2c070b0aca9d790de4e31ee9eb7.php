<?php /*a:1:{s:49:"/www/wwwroot/wx.shichuedu.com/view/apply/edit.php";i:1624688174;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            <div class="layui-tab-item layui-show">
                <form class="layui-form">
					...
					<div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="bao_time" lay-verify="required" placeholder="请输入缴费时间" class="layui-input" id="LAY_demorange_s" value="<?php echo htmlentities($detail['bao_time']); ?>" onclick="layui.laydate({elem: this, istime: true, format: 'YYYY-MM-DD hh:mm:ss'})">
                        </div>
                    </div>
                    <div class="layui-form-item">
