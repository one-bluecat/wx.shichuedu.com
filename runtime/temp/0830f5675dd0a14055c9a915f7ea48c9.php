<?php /*a:1:{s:48:"/www/wwwroot/wx.shichuedu.com/view/money/add.php";i:1606724880;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
		...
		<div class="layui-tab-content">
			<div class="layui-tab-item layui-show">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
                        <input type="text" name="pay_amount" lay-verify="required" placeholder="请输入结算金额，正为加，负为减" class="layui-input" id="pay_amount">
					</div>
				</div>
