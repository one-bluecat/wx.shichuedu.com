<?php /*a:1:{s:50:"/www/wwwroot/wx.shichuedu.com/view/apply/index.php";i:1662435983;}*/ ?>
<!DOCTYPE html>
<html class="iframe-h">
<head>
    <meta charset="UTF-8">
            ...
            <table class="layui-table" lay-even lay-skin="nob">
                ...
                <?php if(is_array($applys) || $applys instanceof \think\Collection || $applys instanceof \think\Paginator): $i = 0; $__LIST__ = $applys;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <tr>
                        ...
                        <td class="hidden-xs"><?php echo htmlentities($vo['memo']); ?></td>
                        ...
                        <td class="hidden-xs"><?php echo htmlentities($vo['bao_time']); ?></td>
