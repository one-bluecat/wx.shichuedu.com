<?php /*a:1:{s:42:"D:\phpstudy_pro\WWW\tp6\view\open\edit.php";i:1606375346;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
			...
			<div class="layui-tab-item layui-show">
				<form class="layui-form" id="admin">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="pay_amount" lay-verify="required" placeholder="网课原价的30%，多次开通需减差价后的30%" class="layui-input" id="pay_amount" value="<?php echo htmlentities($detail['pay_amount']); ?>">
						</div>
					</div>
