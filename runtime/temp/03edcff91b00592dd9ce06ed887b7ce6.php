<?php /*a:1:{s:46:"D:\web\wx.shichuedu.com\view\address\index.php";i:1605795834;}*/ ?>
<!DOCTYPE html>
<html class="iframe-h">
<head>
    <meta charset="UTF-8">
        ...
        <form class="layui-form" action="/index.php/address/index" method="post" id="form">
            <div class="layui-form-item">
                <div class="layui-inline tool-btn">
                    <button class="layui-btn layui-btn-small layui-btn-normal addBtn" data-url="/index.php/address/add"><i class="layui-icon">&#xe654;</i></button>
        ...
        <div class="layui-form" id="table-list" style="overflow-y:auto;">
            <table class="layui-table" lay-even lay-skin="nob">
                ...
                <tr>
                    ...
                    <td class="hidden-xs"><?php echo htmlentities($vo['goods']); ?></td>
                    ...
                    <td>
                        <div class="layui-inline">
                            ...
                            if(isset($_SESSION['admin']['limit']) && $_SESSION['admin']['limit']==1){
                                ?>
                                <button class="layui-btn layui-btn-small layui-btn-normal go-btn goBtn" data-id="1" data-url="/index.php/address/edit?id=<?php echo htmlentities($vo['id']); ?>"><i class="layui-icon">&#xe642;</i></button>
                            <?php }
                            ?>
                            <button style="margin-left:0px;" class="layui-btn layui-btn-small layui-btn-shua go-btn layui-btn-search  searchBtn" data-id="1" data-url="/index.php/address/view?id=<?php echo htmlentities($vo['id']); ?>"><i class="layui-icon">&#xe615;</i></button>
                            <?php
                            if(isset($_SESSION['admin']['limit']) && $_SESSION['admin']['limit']==1){
                                ?>
                                <button class="layui-btn layui-btn-small layui-btn-danger delBtn leftBtn"  data-url="/index.php/address/delete?id=<?php echo htmlentities($vo['id']); ?>"><i class="layui-icon">&#xe640;</i></button>
                            <?php }
                            ?>
                        </div>
                    </td>
...
<script>
    layui.use(['form', 'jquery', 'layer', 'dialog'], function() {
        ...
        $('#table-list').on('click', '.table-list-status', function() {
            ...
            $.ajax({
                url:"<?php echo url('index/address/stat'); ?>",
