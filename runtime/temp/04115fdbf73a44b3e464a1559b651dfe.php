<?php /*a:1:{s:44:"D:\web\wx.shichuedu.com\view\money\index.php";i:1605860930;}*/ ?>
<!DOCTYPE html>
<html class="iframe-h">
<head>
    <meta charset="UTF-8">
        ...
        <form class="layui-form" action="/index.php/address/index" method="post" id="form">
            <div class="layui-form-item">
                <div class="layui-inline tool-btn">
                    <button class="layui-btn layui-btn-small layui-btn-normal addBtn" data-url="/index.php/money/add"><i class="layui-icon">&#xe654;</i></button>
