<?php /*a:1:{s:49:"/www/wwwroot/wx.shichuedu.com/view/money/edit.php";i:1606373520;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
			...
			<div class="layui-tab-item layui-show">
				<form class="layui-form column-content-detail lay-ajax" method="post" id="admin">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="pay_amount" lay-verify="required" placeholder="请输入结算金额" class="layui-input" id="pay_amount" value="<?php echo htmlentities($detail['pay_amount']); ?>">
						</div>
					</div>
					<div class="layui-form-item layui-form-text">
						<label class="layui-form-label"><span style="color: red;">*</span>结算内容：</label>
						<div class="layui-input-block">
                            <input type="text" name="reason" lay-verify="required" placeholder="请输入结算内容" class="layui-input" id="reason" value="<?php echo htmlentities($detail['reason']); ?>">
						</div>
					</div>
...
<script>
    function update(){
        $.ajax({
            url:"<?php echo url('index/money/edit'); ?>",
