<?php /*a:1:{s:50:"/www/wwwroot/wx.shichuedu.com/view/refund/edit.php";i:1606373578;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
			...
			<div class="layui-tab-item layui-show">
				<form class="layui-form" id="admin">
					...
					<div class="layui-form-item layui-form-text">
						...
						<div class="layui-input-block">
							<textarea name="reason" class="layui-textarea" id="reason" lay-verify="required"><?php echo htmlentities($detail['reason']); ?></textarea>
						</div>
					</div>
