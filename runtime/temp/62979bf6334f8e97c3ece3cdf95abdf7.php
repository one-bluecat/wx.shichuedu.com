<?php /*a:1:{s:49:"/www/wwwroot/wx.shichuedu.com/view/open/index.php";i:1662435911;}*/ ?>
<!DOCTYPE html>
<html class="iframe-h">
<head>
    <meta charset="UTF-8">
                ...
                <tr>
                    ...
                    <td>
                        <div class="layui-inline">
                            ...
                            <?php }
                            ?>
                            <button style="margin-left:0px;" class="layui-btn layui-btn-small layui-btn-shua go-btn layui-btn-open  searchBtn" data-id="1" data-url="/index.php/open/view?id=<?php echo htmlentities($vo['id']); ?>"><i class="layui-icon">&#xe615;</i></button>
                            <?php
                            if(isset($_SESSION['admin']['limit']) && $_SESSION['admin']['limit']==1){
                             ?>
