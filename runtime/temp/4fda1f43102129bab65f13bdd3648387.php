<?php /*a:1:{s:48:"/www/wwwroot/wx.shichuedu.com/view/open/edit.php";i:1662435207;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
			...
			<div class="layui-tab-item layui-show">
				<form class="layui-form" id="admin">
					...
					<div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="student_phone" lay-verify="required" placeholder="请输入学员网校账号" class="layui-input" id="student_phone" value="<?php echo htmlentities($detail['student_phone']); ?>">
                        </div>
					</div>
					<div class="layui-form-item">
					...
					<!-- <div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="pay_amount" lay-verify="required" placeholder="协议班赠送为网课原价的60%，第一次填全，后续同一人开课填0" class="layui-input" id="pay_amount" value="<?php echo htmlentities($detail['pay_amount']); ?>">
						</div>
					</div> -->
					<div class="layui-form-item layui-form-text">
						<label class="layui-form-label"><span style="color: red;">*</span>开课原因：</label>
						<div class="layui-input-block">
							<textarea name="reason" class="layui-textarea" id="reason" placeholder="<?php echo htmlentities($detail['reason']); ?>" lay-verify="required"><?php echo htmlentities($detail['reason']); ?></textarea>
						</div>
					</div>
...
<script>
    ...
    function update(){
        $.ajax({
            url:"<?php echo url('index/open/edit'); ?>",
