<?php /*a:1:{s:47:"/www/wwwroot/wx.shichuedu.com/view/ask/edit.php";i:1606446206;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<!--		</div>-->
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" name="name" required lay-verify="required" value="<?php echo htmlentities($detail['item2']); ?>" autocomplete="off" class="layui-input layui-disabled" disabled autocomplete="off">
			</div>
		</div>
		<div class="layui-form-item">
		...
		<div class="layui-form-item layui-form-text">
			...
			<div class="layui-input-block">
				<textarea name="desc" placeholder="<?php echo htmlentities($detail['item1']); ?>" class="layui-textarea layui-disabled" disabled autocomplete="off"></textarea>
			</div>
		</div>
		<div class="layui-form-item">
			<label class="layui-form-label">问题回复：</label>
			<div class="layui-input-block">
				<textarea class="layui-textarea" name="reply_content"   id="reply_content" lay-verify="reply_content" id="LAY_demo_editor"><?php echo htmlentities($detail['reply_content']); ?></textarea>
			</div>
		</div>
        <div class="layui-form-item">
		...
		<div class="layui-input-block">
            <input type="hidden" name="id" value="<?php echo htmlentities($detail['id']); ?>" id="ids">
