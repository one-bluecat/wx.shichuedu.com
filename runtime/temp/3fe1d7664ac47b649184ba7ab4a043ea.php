<?php /*a:1:{s:48:"/www/wwwroot/wx.shichuedu.com/view/open/view.php";i:1662435442;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="page-content-wrap">
    <form class="layui-form">
        ...
        <!-- <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="pay_amount" required lay-verify="required" autocomplete="off" class="layui-input" id="pay_amount" value="<?php echo htmlentities($detail['pay_amount']); ?>">
            </div>
        </div> -->
        <div class="layui-form-item layui-form-text">
            <label class="layui-form-label">开课原因：</label>
            <div class="layui-input-block">
                <textarea name="desc" class="layui-textarea layui-disabled" disabled autocomplete="off"><?php echo htmlentities($detail['reason']); ?></textarea>
            </div>
        </div>
    </form>
</div>
