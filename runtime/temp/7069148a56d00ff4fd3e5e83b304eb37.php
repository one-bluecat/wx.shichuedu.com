<?php /*a:1:{s:47:"/www/wwwroot/wx.shichuedu.com/view/open/add.php";i:1662435184;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
		...
		<div class="layui-tab-content">
			<div class="layui-tab-item layui-show">
				...
				<!-- <div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="pay_amount" lay-verify="required" placeholder="协议班赠送为网课原价的60%，第一次填全，后续同一人开课填0" class="layui-input" id="pay_amount">
					</div>
				</div> -->
