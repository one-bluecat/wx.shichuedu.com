<?php /*a:1:{s:44:"D:\phpstudy_pro\WWW\tp6\view\refund\edit.php";i:1606354529;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<div class="page-content-wrap">
	<div class="layui-tab layui-tab-brief" style="margin: 0;">
		<ul class="layui-tab-title">
			<li><a href="/index.php/refund/index">信息列表</a></li>
			...
			<div class="layui-tab-item layui-show">
				<form class="layui-form" id="admin">
					...
					<div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="student_phone" lay-verify="phone" placeholder="请输入学员网校账号" class="layui-input" id="student_phone" value="<?php echo htmlentities($detail['student_phone']); ?>">
                        </div>
					</div>
                    <div class="layui-form-item">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="pay_amount" lay-verify="required" placeholder="请输入退费金额" class="layui-input" id="pay_amount" value="<?php echo htmlentities($detail['pay_amount']); ?>">
						</div>
					</div>
					<div class="layui-form-item layui-form-text">
						<label class="layui-form-label"><span style="color: red;">*</span>退费原因：</label>
						<div class="layui-input-block">
							<textarea name="reason" class="layui-textarea" id="reason" placeholder="" lay-verify="required"></textarea>
						</div>
					</div>
...
<script>
    document.getElementById("reason").value="<?php echo htmlentities($detail['reason']); ?>"
</script>
...
<script>
    ...
    function update(){
        $.ajax({
            url:"<?php echo url('index/refund/edit'); ?>",
