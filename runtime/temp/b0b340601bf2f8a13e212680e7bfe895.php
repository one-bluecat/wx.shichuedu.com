<?php /*a:1:{s:50:"/www/wwwroot/wx.shichuedu.com/view/refund/view.php";i:1606373606;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
	...
	<form class="layui-form">
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
                <input type="text" name="sale_id" required lay-verify="required" value="<?php echo htmlentities($detail['sale_id']); ?>" class="layui-input layui-disabled" disabled autocomplete="off">
			</div>
		</div>
		<div class="layui-form-item">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
                <input type="text" name="pay_amount" required lay-verify="required" autocomplete="off" class="layui-input layui-disabled" id="pay_amount" value="<?php echo htmlentities($detail['pay_amount']); ?>" disabled autocomplete="off">
			</div>
		</div>
		<div class="layui-form-item layui-form-text">
			<label class="layui-form-label">退费原因：</label>
			<div class="layui-input-block">
				<textarea name="desc" placeholder="<?php echo htmlentities($detail['reason']); ?>" class="layui-textarea layui-disabled" disabled autocomplete="off"><?php echo htmlentities($detail['reason']); ?></textarea>
			</div>
		</div>
	</form>
</div>
